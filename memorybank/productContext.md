# Product Context: King of the Amazons

## Why This Project Exists
This project is a university assignment for a computational introduction course designed to teach students:
...
1. **Complex Game Logic**: The Game of Amazons has non-trivial rules requiring careful state management
...
- Easy to compile and run with minimal setup
- Clear menu system for accessing all required features
- Intuitive controls for testing game functionality
- Comprehensive error handling and edge case management
- Well-documented code and project structure

### For Students (Learning)
- Demonstrates clean C++ code organization
- Shows effective use of object-oriented design patterns
...
- Code should demonstrate good software engineering practices
- Implementation should be understandable to fellow students
- Architecture should support incremental development and testing
