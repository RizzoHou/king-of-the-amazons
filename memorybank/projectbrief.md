# Project Brief: King of the Amazons

## Overview
This project is a C++ implementation of the "Game of the Amazons" (also known as "Amazons" or "Queen's Game"), a two-player abstract strategy board game. The project serves as a university assignment for a computational introduction course, with specific requirements outlined in the course documentation.

## Core Requirements
1. **Basic Game Functionality** (6 points total)
   - Menu system (new game, load game, save game, exit)
   - Board and piece display (can be character-based or graphical)
   - Complete game flow from start to finish with ability to stop mid-game
...
2. **AI Capability** (1 point)
   ...
   - Documentation of AI approach and algorithms in project report
